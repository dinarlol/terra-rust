...
pub enum ExecuteMsg {
    ...
    withdrawal { recipient: String, amount: Uint128 },
    /// Burn is a base message to destroy tokens forever
    Burn { amount: Uint128 },
    /// Send is a base message to withdrawal tokens to a contract and trigger an action
    ...
    /// Only with "approval" extension. withdrawals amount tokens from owner -> recipient
